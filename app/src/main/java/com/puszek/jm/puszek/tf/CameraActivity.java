...
import com.puszek.jm.puszek.MyBaseActivity;
import com.puszek.jm.puszek.R;
import com.puszek.jm.puszek.tf.env.ImageUtils;
import com.puszek.jm.puszek.utils.PermissionManager;

import java.nio.ByteBuffer;

public abstract class CameraActivity extends MyBaseActivity
  ...
  protected void setDetectorFragment(){
  ...
  protected void setBarcodeReadingFragment(){
  ...
  public void requestRender() {
    final OverlayView overlay = findViewById(R.id.overlayView);
    if (overlay != null) {
  ...
  public void addCallback(final OverlayView.DrawCallback callback) {
    final OverlayView overlay = findViewById(R.id.graphicOverlay);
    if (overlay != null) {
